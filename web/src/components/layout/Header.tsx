...
export function Header() {
  ...
  // Imperativa -> forma tradicional, indicamos cada passo para o sistema que ele deve seguir
  // No React usamos a forma declarativa -> criamos uma condiçao e reagimos a essa condição
  ...
  return (
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        ...
        {/* Dialog.Portal joga o componente para o body da aplicação */}
        <Dialog.Portal>
